...
//            L.i("================================lineCount:" + lineCount + "======================================");
            ...
            switch (state) {
                ...
                case STATE_EXPANDED:
                    ...
                    tv_expand_or_collapse.setVisibility(View.VISIBLE);
                    tv_expand_or_collapse.setCompoundDrawablesRelativeWithIntrinsicBounds(0, R.drawable.ic_arrow_up, 0, 0);
                    break;
            }
            tv_expandable_content.setText(text);
        }
    ...
    public void onClick(View v) {
        ...
        if (state == STATE_COLLAPSED) {
            tv_expand_or_collapse.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_arrow_up, 0, 0);
            tv_expandable_content.setMaxLines(Integer.MAX_VALUE);
